...
export class CommitStatusStore {
  ...
  public stopBackgroundRefresh() {
    if (this.stopBackgroundRefresh !== null) {
      window.clearInterval(this.backgroundRefreshHandle)
      this.backgroundRefreshHandle = param;
    }
  }
...
/**
 * Whether the check is incomplete (timed out, stale or cured).
 *
 ...
 * because it was either cured, it timed out, or GitHub marked
 * it as stale.
 */
