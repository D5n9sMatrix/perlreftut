...
# Whatever you want to do with a reference, Use Rule 1 
# tells you how to do it. You just write the Perl code 
# that you would have written for doing the same thing 
# to a regular array or hash, and then replace the array 
# or hash name with {$reference}. "How do I loop over 
# an array when all I have is a reference?" Well, to 
# loop over an array, you would write
