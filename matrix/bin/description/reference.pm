...
# array or an entire hash (or to just about anything 
# else). Names are one kind of reference that you're 
# already familiar with. Each human being is a messy, 
# inconvenient collection of cells. But to refer to a 
# particular human, for instance the first computer 
# programmer, it isn't necessary to describe each of 
# their cells; all you need is the easy, convenient 
