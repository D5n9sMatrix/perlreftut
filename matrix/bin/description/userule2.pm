...
# you how to do absolutely everything you ever need to 
# do with references. But the most common thing to do 
# with an array or a hash is to extract a single element, 
# and the Use Rule 1 notation is cumbersome. So there is 
# an abbreviation.
...
# $aref->[3] is the fourth element of the array. 
# Don't confuse this with $aref[3], which is the 
# fourth element of a totally different array, one 
# deceptively named @aref. $aref and @aref are 
# unrelated the same way that $item and @item are.

# Similarly, $href->{'red'} is part of the hash 
# referred to by the scalar variable $href, perhaps 
# even one with no name. $href{'red'} is part of the 
# deceptively named %href hash. It's easy to forget 
# to leave out the ->, and if you do, you'll get bizarre 
# results when your program gets array and hash elements 
# out of totally unexpected hashes and arrays that 
