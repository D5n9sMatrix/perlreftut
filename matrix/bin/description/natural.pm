...
# The natural way to do this is to have a hash whose 
# keys are country names. Associated with each country 
# name key is a list of the cities in that country. 
# Each time you read a line of input, split it into a 
# country and a city, look up the list of cities already 
# known to be in that country, and append the new city 
# to the list. When you're done reading the input, 
# iterate over the hash as usual, sorting each list 
